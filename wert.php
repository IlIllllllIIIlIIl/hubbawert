...
<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
		<div class="modal-content">
			...
			($isEditor ? '<button type="button" class="btn btn-success btn-sm px-2" data-bs-toggle="collapse" data-bs-target="#newCategoryForm">➕</button>' : '').
			...
			<div class="collapse" id="newCategoryForm">
			    <form method="POST" class="mb-3">
			        ...
			        <div class="d-flex justify-content-between">
			            <button type="button" class="btn btn-secondary btn-sm px-2" data-bs-toggle="collapse" data-bs-target="#newCategoryForm">❌</button>
